...
export default function LoginForm() {
    ...
    return (
        <motion.div
            ...
            className="w-full max-w-md p-8 rounded-2xl glass-card border border-glass-border"
        >
            ...
            <form action={formAction} className="space-y-4">
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        required
                        className="w-full bg-background/50 border border-glass-border rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-500 text-foreground placeholder:text-muted-foreground"
